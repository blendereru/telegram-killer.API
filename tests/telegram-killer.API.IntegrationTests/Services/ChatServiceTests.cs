...
public class ChatServiceTests : IClassFixture<TelegramKillerWebApplicationFactory>, IAsyncLifetime
{
    ...
    [Fact]
    public async Task StoreMessage_DoesNotMoveLastReadBackward_WhenSenderIsAlreadyAhead()
    {
        // Arrange
        Guid chatId;
        Guid senderId;
        ...
        // Act
        var message = await chatService.StoreMessage(chatId, senderId, "New message");
